...
import {
  LayoutDashboard, Users, Mic, FileText, Settings,
  LogOut, Shield
} from 'lucide-react';
...
const NAV_ITEMS = [
  ...
  { label: 'Agents Vocaux', Icon: Mic, path: '/admin/vocal-agents' },
  { label: 'Factures', Icon: FileText, path: '/admin/invoices' },
...
export default function AdminSidebar() {
  ...
  return (
    <aside 
      className={cn(
        "bg-white border-r border-[var(--steel-alabaster)] flex flex-col h-full z-30 shadow-sm transition-all duration-300 ease-in-out overflow-hidden group/sidebar",
        isHovered ? "w-64" : "w-20"
      )}
    ...
    >
      <div className={cn(
        ...
        <div className={cn(
          ...
          <span className="text-[10px] text-indigo-500 font-bold uppercase tracking-widest whitespace-nowrap">Admin Panel</span>
        </div>
      </div>
